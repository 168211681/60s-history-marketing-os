...
export default async function MarketPage() {
  ...
  return <>
    ...
    <Panel title="Track a YouTube channel" description="Only public channel and video metadata is collected. Competitor private analytics are never available."><MarketChannelForm /><p className="footnote">Requires server-side YOUTUBE_DATA_API_KEY. Paste a Channel ID beginning with UC or a full /channel/ URL.</p></Panel>
