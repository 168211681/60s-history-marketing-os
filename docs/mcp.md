...
evidence-labeled insights and a requested topic
...
the generated content. The prompt factory requires the owner's own completed
analytics period so comparisons remain evidence-based.
