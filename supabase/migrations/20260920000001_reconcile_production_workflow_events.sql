...
create table if not exists private.production_workflow_events (
...
create index if not exists production_workflow_events_workflow_created_idx
  on private.production_workflow_events (workflow_id, created_at desc);
create index if not exists production_workflow_events_channel_created_idx
